...
int main(){
    ...
    scanf("%i", n); //se eu estiver afim de deixar dinamico
    ...
    float v1[10] = {1, 2, 5, 4, -1, 4, 4, 6, 3, 10}
    float v2[15] = {1, 2, 5, 4, -1, 4, 4, 6, 3, 10, 11, 12, 13, 14, -15};
    float *ptv1 = v1;
    float *ptv2 = v2;

    printf("menor valor do vetor v1\n");
    minv(ptv1, 10);

    printf("soma dos valores do vetor v1\n");
    sumv(ptv1, 10);

    printf("valor médio v1\n");
    meanv(ptv1, 10);
}
float minv(float * v, int n){
    int i;
